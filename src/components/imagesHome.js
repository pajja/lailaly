const homeImages = {
  ...
  deriveBackground: require("../assets/derive/IMG_3763_edited.jpg"),
  futuresBackground: require("../assets/futures/IMG_4694_edited-2.jpg"),
  womanhoodBackground: require("../assets/womanhood/IMG_5743_edited-4.png"),
};

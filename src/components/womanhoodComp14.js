          ...
          <div className="text-container-womanhoodComp14">
            <div className="columns-two">
              <p className="main-text times-new-roman">
                ...
                shown through some of my initial research such as through
                reading Andrea Dworkin's book as well as Lucas' self portraits.
                Before going on to make prints, I wanted to ensure that I had
                the images I could make into prints so that it would go
                successfully when I did have my time in the print room. I used
                water colours and Quink ink like Dumas used in a lot of her work
                as I felt it a successful medium to be able to create simplistic
                yet impactful images, which is what I would have to do with
                using print inks also. I was preparing myself. I used red and
                blue as my main colour of the skin as it gave an eerie tone. The
                cold tones of the blue which aren't usually found in skin
                colours, I feel gave a nod towards a corpse and deadening. I did
                this to show how women are so sexualised they way as well be a
                corpse; lifeless, to be used and abused for male gain. The red
                was also made to be used eerily and to suggest violence and
                blood and rawness.
              </p>
            </div>
          </div>
          ...
          <div className="text-container-womanhoodComp14 last-pad-w14">
            <div className="columns-two">
              <p className="main-text times-new-roman">
                ...
                some may find these images sexual and inappropriate, they are
                not. At least not in the way of sex but rather depicting
                violence. The images are violent and showing violence. There is
                no sex going on here or anything seductive. It is pornography
                and violence rather than the coming together of two people with
                full consent. I think if my work was to be shown in a gallery,
                it should be inappropriate towards violence and concerning
                imagery rather than 'explicit'. The landscape watercolour, I
                feel, was one of most successful and rich in context images that
                came out of the water media and biro exercise. It pictures the
                lifeless shell of a body hanging onto the frame of the chair
                whilst her organs and life are cast aside. It is a comment on
                the way women are only valued for their appearance, or their
                skin, whilst their aliveness, inner workings, heart and mind
                will always be a second thought. She might as well not even be a
                human or alive; she is valued for her appearance and,
                essentially, as a hole.
              </p>
            </div>
          </div>
        </div>
      </div>
      <div className="custom-scrollbar w14">
        <div className="scrollbar-thumb w14">
